...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <form class="form-signin" action="http://times.bcp.org/clubs/browse.php" method="get">
          <br><br><br>
          <?php if(isset($_GET["state"]) && $_GET["state"] == 1) {
              echo '<div class="alert alert-danger" id = "deletedalert" role="alert">Invalid Student ID.</div>';
          }?>
